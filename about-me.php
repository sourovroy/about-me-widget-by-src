...
add_action( 'plugins_loaded', 'about_me_widget_plugin_load' );
function about_me_widget_plugin_load() {
	load_plugin_textdomain( 'aboutwidget', false, plugin_basename( dirname( __FILE__ ) ) . '/languages' ); 
}
